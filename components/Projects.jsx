  ...
  return (
    <a href={link} target="_blank" className="w-full block shadow-2xl">
      <div className="relative overflow-hidden">
        ...
        <h1 className="absolute top-10 left-10 text-gray-50 font-bold text-xl bg-[#54C2CC] rounded-md px-2">
          {title}
        </h1>
        <h1 className="absolute bottom-10 left-10 text-[#10555B] dark:text-gray-50  font-bold text-xl">
