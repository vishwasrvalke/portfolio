      ...
      <div className="relative z-10 rounded-md shadow-md bg-[#10555B] p-4 md:p-10 lg:p-20 max-w-6xl mx-auto -mt-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="md:ml-4">
            <header>
              ...
              <p className="font-light text-base text-gray-300 mt-2">
                Fill in the details and I&rsquo;ll get back to you as soon as I
                can.
              </p>
            </header>
            <div className="icons-container inline-flex flex-col my-20">
              <div className="flex flex-row items-center space-x-6 rounded-md border border-[#10555B] hover:border hover:border-[#54C2CC] p-4">
                <svg
            ...
            <div className="social-icons flex content-center justify-center space-x-8">
              <a
                ...
                className="h-10 w-10 rounded-full hover:bg-[#54C2CC] flex items-center justify-center cursor-pointer"
              >
                <svg
                  width="24"
                  height="24"
          ...
          >
            ...
            <button
              type="submit"
              className="bg-[#54C2CC] rounded-md mx-4 mt-8 py-2 text-gray-50 text-xs font-bold"
            >
              Send Message
            </button>
          </form>
